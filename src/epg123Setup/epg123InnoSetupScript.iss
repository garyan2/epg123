...
Filename: "{sys}\sc.exe"; Parameters: "create epg123Server start= auto depend= nsi binPath= ""{app}\epg123Server.exe"" displayname= ""EPG123 Server"""; Flags: runhidden; Components: main1\epg123 main1\hdhr main1\plutotv main1\stirr; StatusMsg: "Creating server service..."

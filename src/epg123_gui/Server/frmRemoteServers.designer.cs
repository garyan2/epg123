...
namespace epg123
{
    partial class frmRemoteServers
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Double-click the EPG123 Server on the left to view/edit configuration over HTTP.\r" +
    "\n\r\nIf you don\'t see your desired server, make sure it is running and click \'Refr" +
    "esh\' below.";
            // 
            // btnRefresh
            // 

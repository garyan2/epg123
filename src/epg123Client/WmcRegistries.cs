...
{
    internal static class WmcRegistries
    {
        ...
        public static bool ActivateGuide()
        {
            ...
            {
                Logger.WriteInformation($"Could not write/verify the registry settings to activate the guide in WMC. {ex.Message}\n{ex.StackTrace}");
            }
            return ret;
        }
        ...
        public static bool SetBackgroundScanning(bool enable)
        {
            ...
            {
                Logger.WriteInformation($"Could not write/verify the registry settings to {(enable ? "en" : "dis")}able background scanning. {ex.Message}\n{ex.StackTrace}");
            }
            return ret;
        }
        ...
        public static string GetStoreFilename()
        {
            ...
            {
                Logger.WriteInformation($"Could not construct the store filename from the registry. Using <<null>> to open store. {ex.Message}\n{ex.StackTrace}");
            }
            return ret;
        }
        ...
        public static DateTime NextScheduledRecording()
        {
            ...
            {
                Logger.WriteInformation($"Could not determine when next recording is to start. {ex.Message}\n{ex.StackTrace}");
            }
        ...
        public static bool IsGarbageCleanupDue()
        {
            ...
            {
                Logger.WriteInformation($"Could not verify when garbage cleanup was last run. {ex.Message}\n{ex.StackTrace}");
            }
            return ret;
        }

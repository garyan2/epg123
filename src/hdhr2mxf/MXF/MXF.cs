...
namespace hdhr2mxf.MXF
{
    ...
    public class mxf
    {
        private readonly string _progName = "HDHR2MXF";
        private readonly string _progDesc = "EPG123 SiliconDust HDHR to MXF";
    ...
    public class MxfWith
    {
        ...
        public string GetSeasonId(string seriesId, string seasonNumber)
        {
            ...
            Seasons.Add(season = new MxfSeason()
            {
                ...
                Title = $"{GetSeriesInfo(seriesId).Title}, Season {seasonNumber}",
                Zap2It = seriesId
            });
        ...
        {
            if (_lineups.TryGetValue(hdhrType, out var lineup)) return lineup;
